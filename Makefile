...
FlappyBirds: Build/Main.o Build/Bird.o Build/Pipe.o Build/PipeManager.o Build/Game.o Build/GameManager.o
	g++ Build/*.o -o FlappyBirds -L$(SFML_PATH)/lib -lsfml-graphics -lsfml-window -lsfml-system -static-libgcc -static-libstdc++

Build/Main.o: Source/Main.cpp Header/Game.h Header/GameManager.h
